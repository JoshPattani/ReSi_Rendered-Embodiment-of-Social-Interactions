...
int peak = 0, trough = 4095;  // Updated for 12-bit ADC
float thresholdFactor = 0.7;  // Adaptive threshold factor
int threshold = 1100;  // Adjusted default threshold for 12-bit ADC
...
void loop() {
    ...
    threshold = trough + (peak - trough) * thresholdFactor;  // Dynamic threshold
