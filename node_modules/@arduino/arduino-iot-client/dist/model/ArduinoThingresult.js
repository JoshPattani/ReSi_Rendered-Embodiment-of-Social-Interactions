 ...
 * @version 3.0.0
 */
var ArduinoThingresult = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoThingresult(id, sketchId) {
    _classCallCheck(this, ArduinoThingresult);
   ...
   */
  return _createClass(ArduinoThingresult, null, [{
    key: "initialize",
    value: function initialize(obj, id, sketchId) {
      obj['id'] = id;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoThingresult.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ArduinoThingresult;