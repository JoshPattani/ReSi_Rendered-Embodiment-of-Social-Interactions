...
var _BatchQueryRawResponseSeriesMediaV = _interopRequireDefault(require("./BatchQueryRawResponseSeriesMediaV1"));
 ...
 * @version 3.0.0
 */
var ArduinoSeriesRawResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesRawResponse(countValues, fromDate, query, respVersion, series, sort, status, times, toDate, values) {
    _classCallCheck(this, ArduinoSeriesRawResponse);
   ...
   */
  return _createClass(ArduinoSeriesRawResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('property_name')) {
          obj['property_name'] = _ApiClient["default"].convertToType(data['property_name'], 'String');
        }
        if (data.hasOwnProperty('property_type')) {
          obj['property_type'] = _ApiClient["default"].convertToType(data['property_type'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesRawResponse.RequiredProperties),
        _step;
      try {
      ...
      if (data['series']) {
        // data not null
        _BatchQueryRawResponseSeriesMediaV["default"].validateJSON(data['series']);
      }
      // ensure the json data is a string
...
var _default = exports["default"] = ArduinoSeriesRawResponse;