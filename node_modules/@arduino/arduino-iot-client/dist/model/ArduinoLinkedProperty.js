 ...
 * @version 3.0.0
 */
var ArduinoLinkedProperty = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoLinkedProperty(property, status) {
    _classCallCheck(this, ArduinoLinkedProperty);
   ...
   */
  return _createClass(ArduinoLinkedProperty, null, [{
    key: "initialize",
    value: function initialize(obj, property, status) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('property')) {
          obj['property'] = _ArduinoProperty["default"].constructFromObject(data['property']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoLinkedProperty.RequiredProperties),
        _step;
      try {
      ...
      if (data['property']) {
        // data not null
        _ArduinoProperty["default"].validateJSON(data['property']);
      }
...
var _default = exports["default"] = ArduinoLinkedProperty;