...
var _UserRecipient = _interopRequireDefault(require("./UserRecipient"));
 ...
 * @version 3.0.0
 */
var EmailDeliveryOpts = /*#__PURE__*/function () {
  /**
   ...
   */
  function EmailDeliveryOpts(to) {
    _classCallCheck(this, EmailDeliveryOpts);
   ...
   */
  return _createClass(EmailDeliveryOpts, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('bcc')) {
          obj['bcc'] = _ApiClient["default"].convertToType(data['bcc'], [_UserRecipient["default"]]);
        }
        if (data.hasOwnProperty('cc')) {
          obj['cc'] = _ApiClient["default"].convertToType(data['cc'], [_UserRecipient["default"]]);
        }
        if (data.hasOwnProperty('to')) {
          obj['to'] = _ApiClient["default"].convertToType(data['to'], [_UserRecipient["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EmailDeliveryOpts.RequiredProperties),
        _step;
      try {
      ...
      if (data['bcc']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['bcc']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _UserRecipient["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['cc']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _UserRecipient["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['to']) {
        ...
        var _iterator4 = _createForOfIteratorHelper(data['to']),
          _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var _item2 = _step4.value;
            _UserRecipient["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
...
var _default = exports["default"] = EmailDeliveryOpts;