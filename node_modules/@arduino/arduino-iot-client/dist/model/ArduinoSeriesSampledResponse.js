 ...
 * @version 3.0.0
 */
var ArduinoSeriesSampledResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesSampledResponse(countValues, fromDate, interval, query, respVersion, status, times, toDate, values) {
    _classCallCheck(this, ArduinoSeriesSampledResponse);
   ...
   */
  return _createClass(ArduinoSeriesSampledResponse, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesSampledResponse.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ArduinoSeriesSampledResponse;