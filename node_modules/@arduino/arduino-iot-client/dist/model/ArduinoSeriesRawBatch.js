...
var _ArduinoSeriesRawResponse = _interopRequireDefault(require("./ArduinoSeriesRawResponse"));
 ...
 * @version 3.0.0
 */
var ArduinoSeriesRawBatch = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesRawBatch(respVersion, responses) {
    _classCallCheck(this, ArduinoSeriesRawBatch);
   ...
   */
  return _createClass(ArduinoSeriesRawBatch, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesRawBatch.RequiredProperties),
        _step;
      try {
      ...
      if (data['responses']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoSeriesRawResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoSeriesRawBatch;