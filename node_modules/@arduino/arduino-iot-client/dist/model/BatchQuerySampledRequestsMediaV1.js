...
var _BatchQuerySampledRequestMediaV = _interopRequireDefault(require("./BatchQuerySampledRequestMediaV1"));
 ...
 * @version 3.0.0
 */
var BatchQuerySampledRequestsMediaV1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function BatchQuerySampledRequestsMediaV1(requests, respVersion) {
    _classCallCheck(this, BatchQuerySampledRequestsMediaV1);
   ...
   */
  return _createClass(BatchQuerySampledRequestsMediaV1, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('requests')) {
          obj['requests'] = _ApiClient["default"].convertToType(data['requests'], [_BatchQuerySampledRequestMediaV["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BatchQuerySampledRequestsMediaV1.RequiredProperties),
        _step;
      try {
      ...
      if (data['requests']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _BatchQuerySampledRequestMediaV["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = BatchQuerySampledRequestsMediaV1;