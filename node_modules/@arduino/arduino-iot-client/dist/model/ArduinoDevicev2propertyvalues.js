...
var _ArduinoDevicev2propertyvalue = _interopRequireDefault(require("./ArduinoDevicev2propertyvalue"));
var _ArduinoDevicev2propertyvaluesLastEvaluatedKey = _interopRequireDefault(require("./ArduinoDevicev2propertyvaluesLastEvaluatedKey"));
 ...
 * @version 3.0.0
 */
var ArduinoDevicev2propertyvalues = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoDevicev2propertyvalues(id, lastEvaluatedKey, name, values) {
    _classCallCheck(this, ArduinoDevicev2propertyvalues);
   ...
   */
  return _createClass(ArduinoDevicev2propertyvalues, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoDevicev2propertyvalues.RequiredProperties),
        _step;
      try {
      ...
      if (data['last_evaluated_key']) {
        // data not null
        _ArduinoDevicev2propertyvaluesLastEvaluatedKey["default"].validateJSON(data['last_evaluated_key']);
      }
      // ensure the json data is a string
      ...
      if (data['values']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoDevicev2propertyvalue["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoDevicev2propertyvalues;