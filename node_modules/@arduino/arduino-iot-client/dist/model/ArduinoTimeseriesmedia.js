...
var _TimeseriesDataPoint = _interopRequireDefault(require("./TimeseriesDataPoint"));
 ...
 * @version 3.0.0
 */
var ArduinoTimeseriesmedia = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoTimeseriesmedia(data) {
    _classCallCheck(this, ArduinoTimeseriesmedia);
   ...
   */
  return _createClass(ArduinoTimeseriesmedia, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoTimeseriesmedia.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _TimeseriesDataPoint["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoTimeseriesmedia;