...
var _BatchQueryRequestMediaV = _interopRequireDefault(require("./BatchQueryRequestMediaV1"));
 ...
 * @version 3.0.0
 */
var BatchQueryRequestsMediaV1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function BatchQueryRequestsMediaV1(requests, respVersion) {
    _classCallCheck(this, BatchQueryRequestsMediaV1);
   ...
   */
  return _createClass(BatchQueryRequestsMediaV1, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BatchQueryRequestsMediaV1.RequiredProperties),
        _step;
      try {
      ...
      if (data['requests']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _BatchQueryRequestMediaV["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = BatchQueryRequestsMediaV1;