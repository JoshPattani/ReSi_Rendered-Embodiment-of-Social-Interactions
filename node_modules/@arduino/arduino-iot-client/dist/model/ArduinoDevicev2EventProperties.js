 ...
 * @version 3.0.0
 */
var ArduinoDevicev2EventProperties = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoDevicev2EventProperties(events, id) {
    _classCallCheck(this, ArduinoDevicev2EventProperties);
   ...
   */
  return _createClass(ArduinoDevicev2EventProperties, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoDevicev2EventProperties.RequiredProperties),
        _step;
      try {
      ...
      if (data['events']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoDevicev2SimpleProperties["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoDevicev2EventProperties;