...
var _BodyExpression = _interopRequireDefault(require("./BodyExpression"));
var _EmailDeliveryOpts = _interopRequireDefault(require("./EmailDeliveryOpts"));
var _TitleExpression = _interopRequireDefault(require("./TitleExpression"));
 ...
 * @version 3.0.0
 */
var EmailAction = /*#__PURE__*/function () {
  /**
   ...
   */
  function EmailAction(body, delivery, subject) {
   ...
   */
  return _createClass(EmailAction, null, [{
    key: "initialize",
    value: function initialize(obj, body, delivery, subject) {
      obj['body'] = body;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('body')) {
          obj['body'] = _BodyExpression["default"].constructFromObject(data['body']);
        }
        if (data.hasOwnProperty('delivery')) {
          obj['delivery'] = _EmailDeliveryOpts["default"].constructFromObject(data['delivery']);
        }
        if (data.hasOwnProperty('subject')) {
          obj['subject'] = _TitleExpression["default"].constructFromObject(data['subject']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EmailAction.RequiredProperties),
        _step;
      try {
      ...
      if (data['body']) {
        // data not null
        _BodyExpression["default"].validateJSON(data['body']);
      }
      // validate the optional field `delivery`
      if (data['delivery']) {
        // data not null
        _EmailDeliveryOpts["default"].validateJSON(data['delivery']);
      }
      // validate the optional field `subject`
      if (data['subject']) {
        // data not null
        _TitleExpression["default"].validateJSON(data['subject']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = EmailAction;