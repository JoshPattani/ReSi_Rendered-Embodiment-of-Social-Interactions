...
var _ArduinoSeriesSampledResponse = _interopRequireDefault(require("./ArduinoSeriesSampledResponse"));
 ...
 * @version 3.0.0
 */
var ArduinoSeriesBatchSampled = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesBatchSampled(respVersion, responses) {
    _classCallCheck(this, ArduinoSeriesBatchSampled);
   ...
   */
  return _createClass(ArduinoSeriesBatchSampled, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('responses')) {
          obj['responses'] = _ApiClient["default"].convertToType(data['responses'], [_ArduinoSeriesSampledResponse["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesBatchSampled.RequiredProperties),
        _step;
      try {
      ...
      if (data['responses']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['responses']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _ArduinoSeriesSampledResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoSeriesBatchSampled;