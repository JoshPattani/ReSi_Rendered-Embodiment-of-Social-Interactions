...
var Template = /*#__PURE__*/function () {
  ...
  return _createClass(Template, null, [{
    key: "initialize",
    value: function initialize(obj, templateName) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('custom_template_id')) {
          obj['custom_template_id'] = _ApiClient["default"].convertToType(data['custom_template_id'], 'String');
        }
        if (data.hasOwnProperty('prefix_name')) {
          obj['prefix_name'] = _ApiClient["default"].convertToType(data['prefix_name'], 'String');
        }
        ...
        if (data.hasOwnProperty('things_options')) {
          obj['things_options'] = _ApiClient["default"].convertToType(data['things_options'], {
            'String': Object
          });
        }
      }
