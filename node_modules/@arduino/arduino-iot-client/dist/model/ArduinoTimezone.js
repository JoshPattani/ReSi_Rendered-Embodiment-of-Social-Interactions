 ...
 * @version 3.0.0
 */
var ArduinoTimezone = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoTimezone(name, offset, until) {
    _classCallCheck(this, ArduinoTimezone);
   ...
   */
  return _createClass(ArduinoTimezone, null, [{
    key: "initialize",
    value: function initialize(obj, name, offset, until) {
      obj['name'] = name;
      obj['offset'] = offset;
      obj['until'] = until;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoTimezone.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ArduinoTimezone;