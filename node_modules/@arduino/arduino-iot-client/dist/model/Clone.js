  ...
  return _createClass(Clone, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('overrides')) {
          obj['overrides'] = _ApiClient["default"].convertToType(data['overrides'], [_Override["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['overrides']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['overrides']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _Override["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
