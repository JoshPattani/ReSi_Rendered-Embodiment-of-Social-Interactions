 ...
 * @version 3.0.0
 */
var ThingClone = /*#__PURE__*/function () {
  /**
   ...
   */
  function ThingClone(name) {
    _classCallCheck(this, ThingClone);
   ...
   */
  return _createClass(ThingClone, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('include_tags')) {
          obj['include_tags'] = _ApiClient["default"].convertToType(data['include_tags'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ThingClone.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ThingClone;