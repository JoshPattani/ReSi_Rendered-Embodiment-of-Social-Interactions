...
var _ArduinoAction = _interopRequireDefault(require("./ArduinoAction"));
var _DeviceStatusSource = _interopRequireDefault(require("./DeviceStatusSource"));
 ...
 * @version 3.0.0
 */
var ArduinoTrigger = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoTrigger(name) {
    _classCallCheck(this, ArduinoTrigger);
   ...
   */
  return _createClass(ArduinoTrigger, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('actions')) {
          obj['actions'] = _ApiClient["default"].convertToType(data['actions'], [_ArduinoAction["default"]]);
        }
        ...
        if (data.hasOwnProperty('device_status_source')) {
          obj['device_status_source'] = _DeviceStatusSource["default"].constructFromObject(data['device_status_source']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoTrigger.RequiredProperties),
        _step;
      try {
      ...
      if (data['actions']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['actions']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _ArduinoAction["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['device_status_source']) {
        // data not null
        _DeviceStatusSource["default"].validateJSON(data['device_status_source']);
      }
      // ensure the json data is a string
...
var _default = exports["default"] = ArduinoTrigger;