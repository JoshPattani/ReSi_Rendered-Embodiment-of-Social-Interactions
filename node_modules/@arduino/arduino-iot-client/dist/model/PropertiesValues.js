...
var _PropertiesValue = _interopRequireDefault(require("./PropertiesValue"));
 ...
 * @version 3.0.0
 */
var PropertiesValues = /*#__PURE__*/function () {
  /**
   ...
   */
  function PropertiesValues(properties) {
    _classCallCheck(this, PropertiesValues);
   ...
   */
  return _createClass(PropertiesValues, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PropertiesValues.RequiredProperties),
        _step;
      try {
      ...
      if (data['properties']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _PropertiesValue["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = PropertiesValues;