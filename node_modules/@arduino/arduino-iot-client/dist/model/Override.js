...
var Override = /*#__PURE__*/function () {
   ...
   */
  function Override(newThingId, oldThingId) {
   ...
   */
  return _createClass(Override, null, [{
    key: "initialize",
    value: function initialize(obj, newThingId, oldThingId) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('new_thing_id')) {
          obj['new_thing_id'] = _ApiClient["default"].convertToType(data['new_thing_id'], 'String');
        }
        if (data.hasOwnProperty('old_thing_id')) {
          obj['old_thing_id'] = _ApiClient["default"].convertToType(data['old_thing_id'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(Override.RequiredProperties),
        _step;
      try {
