 ...
 * @version 3.0.0
 */
var TitleExpression = /*#__PURE__*/function () {
  /**
   ...
   */
  function TitleExpression(expression) {
    _classCallCheck(this, TitleExpression);
   ...
   */
  return _createClass(TitleExpression, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('variables')) {
          obj['variables'] = _ApiClient["default"].convertToType(data['variables'], [_Variable["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TitleExpression.RequiredProperties),
        _step;
      try {
      ...
      if (data['variables']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _Variable["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = TitleExpression;