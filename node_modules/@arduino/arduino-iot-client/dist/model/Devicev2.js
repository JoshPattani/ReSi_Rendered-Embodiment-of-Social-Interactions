 ...
 * @version 3.0.0
 */
var Devicev2 = /*#__PURE__*/function () {
  /**
   ...
   */
  return _createClass(Devicev2, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('soft_deleted')) {
          obj['soft_deleted'] = _ApiClient["default"].convertToType(data['soft_deleted'], 'Boolean');
        }
...
var _default = exports["default"] = Devicev2;