...
var _BatchQueryRawLastValueRequestMediaV = _interopRequireDefault(require("./BatchQueryRawLastValueRequestMediaV1"));
 ...
 * @version 3.0.0
 */
var BatchLastValueRequestsMediaV1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function BatchLastValueRequestsMediaV1(requests) {
    _classCallCheck(this, BatchLastValueRequestsMediaV1);
   ...
   */
  return _createClass(BatchLastValueRequestsMediaV1, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BatchLastValueRequestsMediaV1.RequiredProperties),
        _step;
      try {
      ...
      if (data['requests']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _BatchQueryRawLastValueRequestMediaV["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = BatchLastValueRequestsMediaV1;