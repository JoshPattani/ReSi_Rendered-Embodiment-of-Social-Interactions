...
var _ArduinoSeriesResponse = _interopRequireDefault(require("./ArduinoSeriesResponse"));
 ...
 * @version 3.0.0
 */
var ArduinoSeriesBatch = /*#__PURE__*/function () {
  /**
   ...
   */
  function ArduinoSeriesBatch(respVersion, responses) {
    _classCallCheck(this, ArduinoSeriesBatch);
   ...
   */
  return _createClass(ArduinoSeriesBatch, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ArduinoSeriesBatch.RequiredProperties),
        _step;
      try {
      ...
      if (data['responses']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ArduinoSeriesResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ArduinoSeriesBatch;