 ...
 * @version 3.0.0
 */
var UserRecipient = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UserRecipient</code>.
   * @alias module:model/UserRecipient
   * @param id {String} The id of the user
   */
  function UserRecipient(id) {
    _classCallCheck(this, UserRecipient);
   ...
   */
  return _createClass(UserRecipient, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UserRecipient.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = UserRecipient;