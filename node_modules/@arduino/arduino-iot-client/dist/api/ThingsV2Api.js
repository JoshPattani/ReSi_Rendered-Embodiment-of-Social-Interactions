...
var _ArduinoThingtemplate = _interopRequireDefault(require("../model/ArduinoThingtemplate"));
var _Error = _interopRequireDefault(require("../model/Error"));
var _ThingClone = _interopRequireDefault(require("../model/ThingClone"));
...
var ThingsV2Api = exports["default"] = /*#__PURE__*/function () {
  ...
  */
   ...
   */
  return _createClass(ThingsV2Api, [{
    key: "thingsV2CloneWithHttpInfo",
    value: function thingsV2CloneWithHttpInfo(id, thingClone, opts) {
      opts = opts || {};
      var postBody = thingClone;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new _Error["default"]("Missing the required parameter 'id' when calling thingsV2Clone");
      }
      // verify the required parameter 'thingClone' is set
      if (thingClone === undefined || thingClone === null) {
        throw new _Error["default"]("Missing the required parameter 'thingClone' when calling thingsV2Clone");
      }
      var pathParams = {
        'id': id
      };
      ...
      return this.apiClient.callApi('/iot/v2/things/{id}/clone', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "thingsV2Clone",
    value: function thingsV2Clone(id, thingClone, opts) {
      return this.thingsV2CloneWithHttpInfo(id, thingClone, opts).then(function (response_and_data) {
    ...
    value: function thingsV2CreateWithHttpInfo(thingCreate, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2CreateSketchWithHttpInfo(id, thingSketch, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}/sketch', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2DeleteWithHttpInfo(id, opts) {
      ...
      var returnType = null;
      return this.apiClient.callApi('/iot/v2/things/{id}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2DeleteSketchWithHttpInfo(id, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}/sketch', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2ListWithHttpInfo(opts) {
      ...
      var returnType = [_ArduinoThing["default"]];
      return this.apiClient.callApi('/iot/v2/things', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2ShowWithHttpInfo(id, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "thingsV2TemplateWithHttpInfo",
    value: function thingsV2TemplateWithHttpInfo(id, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new _Error["default"]("Missing the required parameter 'id' when calling thingsV2Template");
      }
      var pathParams = {
        'id': id
      };
      ...
      var authNames = ['oauth2'];
      var contentTypes = [];
      var accepts = ['application/vnd.arduino.thingtemplate+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThingtemplate["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}/template', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "thingsV2Template",
    value: function thingsV2Template(id, opts) {
      return this.thingsV2TemplateWithHttpInfo(id, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    value: function thingsV2UpdateWithHttpInfo(id, thingUpdate, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function thingsV2UpdateSketchWithHttpInfo(id, sketchId, opts) {
      ...
      var accepts = ['application/vnd.arduino.thing+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoThing["default"];
      return this.apiClient.callApi('/iot/v2/things/{id}/sketch/{sketchId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
