...
var DevicesV2CertsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
   ...
   */
  return _createClass(DevicesV2CertsApi, [{
    ...
    value: function devicesV2CertsCreateWithHttpInfo(id, createDevicesV2CertsPayload) {
      ...
      return this.apiClient.callApi('/iot/v2/devices/{id}/certs', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function devicesV2CertsDeleteWithHttpInfo(cid, id) {
      ...
      var returnType = null;
      return this.apiClient.callApi('/iot/v2/devices/{id}/certs/{cid}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function devicesV2CertsListWithHttpInfo(id) {
      ...
      var returnType = [_ArduinoDevicev2Cert["default"]];
      return this.apiClient.callApi('/iot/v2/devices/{id}/certs', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function devicesV2CertsShowWithHttpInfo(cid, id) {
      ...
      var accepts = ['application/vnd.arduino.devicev2.cert+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoDevicev2Cert["default"];
      return this.apiClient.callApi('/iot/v2/devices/{id}/certs/{cid}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function devicesV2CertsUpdateWithHttpInfo(cid, id, devicev2Cert) {
      ...
      var accepts = ['application/vnd.arduino.devicev2.cert+json', 'application/vnd.goa.error+json'];
      var returnType = _ArduinoDevicev2Cert["default"];
      return this.apiClient.callApi('/iot/v2/devices/{id}/certs/{cid}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
